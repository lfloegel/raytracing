...
class lambertian : public material {
    public:
        lambertian(const color& a) : albedo(make_shared<solid_color>(a)) {} //texture pointer 
        ...
        virtual bool scatter(
            ...
            scattered = ray(rec.p, scatter_direction, r_in.time()); //sets ray origin at hit point and direction of 
                                                                    //scatter 
                                                                    //scattered rays at time of incident ray 
...
class diffuse_light : public material  {
    public:
        ...
        virtual bool scatter( //does not reflect 
            const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered
        ) const override {
            return false;
        }
